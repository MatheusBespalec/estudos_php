<div class="box-content w100">
	...
	<?php 
		...
		if (isset($_GET['excluir'])) {
			...
			Painel::deleteImageslide($_GET['imagem']);
			//Limpar Url
	...
	<div class="wraper-table">
		<table>
			...
			<?php foreach (Painel::pagination($table,($currentPage - 1) * $perPage,$perPage) as $key => $value) { ?>
				<tr>
					<td><?php echo '<img src="'.INCLUDE_PATH.'images/slides/'.$value['img'].'"/>' ?></td>
					<td><?php echo $value['img'] ?></td>
					<td><a class="delete" href="<?php echo '?excluir='.$value['id'].'&imagem='.$value['img']; ?>"><i class="fa fa-times"></i> Ecluir</a></td>
